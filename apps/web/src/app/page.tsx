...
import SmartSimpleBrilliant from "@/components/ui/ssb";
import YourWorkInSync from "@/components/ui/your-work-in-sync";
import EffortlessIntegration from "@/components/ui/integration-section";
import NumbersThatSpeak from "@/components/ui/numbers-section";
import TestimonialsSection from "@/components/ui/testimonials";
import PricingSection from "@/components/ui/pricing";
import FAQSection from "@/components/ui/faq-section";
import CTASection from "@/components/ui/cta";
import FooterSection from "@/components/ui/footer";
import DocumentationSection from "@/components/ui/doc-section";
import Link from "next/link";
import { Github, Search, Terminal } from "lucide-react";
import { DevdocsCli } from "@/components/ui/devdocs-cli";
          ...
          <div className="self-stretch pt-[9px] overflow-hidden border-b border-[rgba(55,50,47,0.06)] flex flex-col justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-[66px] relative z-10">
            ...
            <div className="w-full h-12 sm:h-14 md:h-16 lg:h-[84px] absolute left-0 top-0 flex justify-center items-center z-20 px-6 sm:px-8 md:px-12 lg:px-0">
              ...
              <div className="w-full max-w-[calc(100%-32px)] sm:max-w-[calc(100%-48px)] md:max-w-[calc(100%-64px)] lg:max-w-[700px] lg:w-[700px] h-10 sm:h-11 md:h-12 py-1.5 sm:py-2 px-3 sm:px-4 md:px-4 pr-2 sm:pr-3 bg-[#F7F5F3] backdrop-blur-sm shadow-[0px_0px_0px_2px_white] overflow-hidden rounded-[50px] flex justify-between items-center relative z-30">
                ...
                <div className="flex flex-1 flex-row items-center justify-end gap-1.5 max-lg:hidden">
                  <button className="inline-flex w-full max-w-[240px] items-center gap-2 rounded-full border border-gray-200 bg-white p-1.5 ps-2.5 text-sm text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-900">
                    <Search className="size-4" />
                    <span>Search</span>
                    <div className="ms-auto inline-flex gap-0.5">
                      <kbd className="rounded-md border border-gray-200 bg-gray-50 px-1.5 font-sans text-xs text-gray-700">Ctrl</kbd>
                      <kbd className="rounded-md border border-gray-200 bg-gray-50 px-1.5 font-sans text-xs text-gray-700">K</kbd>
                    </div>
                  </button>
                    <a href="https://github.com/yashdev9274/devdoc" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center rounded-md p-1.5 text-gray-700 transition-colors hover:bg-gray-100 hover:text-gray-900">
            ...
            <div className="pt-16 sm:pt-20 md:pt-24 lg:pt-[216px] pb-8 sm:pb-12 md:pb-16 flex flex-col justify-start items-center px-2 sm:px-4 md:px-8 lg:px-0 w-full sm:pl-0 sm:pr-0 pl-0 pr-0">
              <div className="w-full max-w-[937px] lg:w-[937px] flex flex-col justify-center items-center gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                <div className="self-stretch rounded-[3px] flex flex-col justify-center items-center gap-4 sm:gap-5 md:gap-6 lg:gap-8">
                  <div className="w-full max-w-[748.71px] lg:w-[748.71px] text-center flex justify-center flex-col text-[#37322F] text-[24px] xs:text-[28px] sm:text-[36px] md:text-[52px] lg:text-[80px] font-normal leading-[1.1] sm:leading-[1.15] md:leading-[1.2] lg:leading-24 font-serif px-2 sm:px-4 md:px-0">
                    Beautiful, Performant Docs
                    <br />
                    with Devdocs
                  </div>
                  <div className="w-full max-w-[506.08px] lg:w-[506.08px] text-center flex justify-center flex-col text-[rgba(55,50,47,0.80)] sm:text-lg md:text-xl leading-[1.4] sm:leading-[1.45] md:leading-[1.5] lg:leading-7 font-sans px-2 sm:px-4 md:px-0 lg:text-lg font-medium text-sm">
                    Devdocs is a documentation framework for developers that's flexible, performant, and runs on your React framework.
                    <br className="hidden sm:block" />
                    Create stunning documentation sites with ease.
                  </div>
                </div>
              </div>
              ...
              <div className="w-full max-w-[960px] lg:w-[960px] pt-2 sm:pt-4 pb-6 sm:pb-8 md:pb-10 px-2 sm:px-4 md:px-6 lg:px-11 flex flex-col justify-center items-center gap-2 relative z-5 my-8 sm:my-12 md:my-16 lg:my-16 mb-0 lg:pb-0">
                <div className="w-full max-w-[960px] lg:w-[960px] aspect-[16/10] sm:aspect-[16/9] bg-white shadow-[0px_0px_0px_0.9056603908538818px_rgba(0,0,0,0.08)] overflow-hidden rounded-[6px] sm:rounded-[8px] lg:rounded-[9.06px] flex flex-col justify-start items-start">
                  {/* Dashboard Content */}
              ...
              <div className="self-stretch border-t border-[#E0DEDB] border-b border-[#E0DEDB] flex justify-center items-start">
                ...
                <div className="flex-1 px-0 sm:px-2 md:px-0 flex flex-col md:flex-row justify-center items-stretch gap-0">
                  ...
                  <FeatureCard
                    title="Easy to Use"
                    description="Get started in minutes with our intuitive setup and configuration."
                  ...
                  <FeatureCard
                    title="Blazing Fast"
                    description="Built on top of modern technologies for a fast and responsive experience."
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-24 py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[586px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Devdocs is trusted by developers around the world to create
                      <br className="hidden sm:block" />
                      beautiful and effective documentation.
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full border-b border-[rgba(55,50,47,0.12)] flex flex-col justify-center items-center">
                ...
                <div className="self-stretch px-4 sm:px-6 md:px-8 lg:px-0 lg:max-w-[1060px] lg:w-[1060px] py-8 sm:py-12 md:py-16 border-b border-[rgba(55,50,47,0.12)] flex justify-center items-center gap-6">
                  <div className="w-full max-w-[616px] lg:w-[616px] px-4 sm:px-6 py-4 sm:py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-3 sm:gap-4 shadow-none">
                    ...
                    <div className="self-stretch text-center text-[#605A57] text-sm sm:text-base font-normal leading-6 sm:leading-7 font-sans">
                      Devdocs provides all the tools you need to build a
                      <br />
                      beautiful and functional documentation site.
                    </div>
                  </div>
                </div>
                ...
                <div className="self-stretch flex justify-center items-start">
                  ...
                  <div className="flex-1 grid grid-cols-1 md:grid-cols-2 gap-0 border-l border-r border-[rgba(55,50,47,0.12)]">
                    ...
                    <div className="md:col-span-2 border-b border-r-0 md:border-r border-[rgba(55,50,47,0.12)] p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col justify-start items-start gap-4 sm:gap-6">
                      <div className="mb-8 flex items-center gap-2 text-gray-600">
                        <Terminal className="h-5 w-5" />
                        <span className="text-sm font-medium">Devdocs CLI</span>
                      </div>
                      <div className="flex flex-col gap-2">
                        ...
                        Devdocs CLI creates interactive components for your docs, offering a rich experience to your users.
                        </p>
                      </div>
                      <div className="w-full mt-8 h-[200px] sm:h-[250px] md:h-[300px] rounded-lg flex items-center justify-center overflow-hidden">
                       <DevdocsCli/>
                      </div>
                    </div>
